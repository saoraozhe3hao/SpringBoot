...
import com.xianqingzao.yequxiaoquan.admin.dao.UserMapper;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        User userResult = userMapper.getUser(new User(username));
        return new org.springframework.security.core.userdetails.User(username, userResult.getPassword(), true, true,
